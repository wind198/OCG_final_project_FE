...
export const SET_ADD_TO_CART_FAIL="setQuantitySelectedFail";
export const CLEAR_WARNING_STATE="clearWarningState";
export const SET_PAGE = "setPage";
export const SET_MAIN_PAGE = "setMainPage";
export const SHOW_SEARCH_BAR="showSearchBar";
 
export const HIDE_SEARCH_BAR="hideSearchBar";
 
export const SET_SEARCH_KEYWORD="setKeyWord";
